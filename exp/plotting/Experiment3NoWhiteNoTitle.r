...
for( i in 1:6){
  ...
  text(x = 29, y = 8000, labels = bquote(paste(frac(abs(italic(" addedX ")), abs(italic(" totalX "))), " = ", .(prop))), cex = 0.6)
  text(x = 29, y = 6000, labels = expression(paste(abs(italic(" totalX ")), " = 32.6k")), cex = 0.6)
