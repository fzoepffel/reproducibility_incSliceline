...
pdf(file="plots/Experiment4_Prop30.pdf",
...
text(x = lastXPoints[floor(length(lastXPoints)/3)] , y = 35, labels = expression(paste(frac(abs(italic(" addedX ")), abs(italic(" totalX "))), " = 0.3")), cex = 0.5)
